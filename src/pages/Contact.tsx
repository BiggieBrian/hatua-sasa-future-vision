        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              Get in touch with HatuaSasa Network. We'd love to hear from you and explore how we can work together.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            <div className="bg-gradient-to-br from-green-100 to-blue-100 rounded-xl h-96 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-600">Our office location in Nairobi, Kenya</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card>
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">How can I volunteer with HatuaSasa Network?</h3>
                <p className="text-gray-600">
                  Visit our Get Involved page to see current volunteer opportunities, or contact us directly to discuss how your skills can contribute to our mission.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">Do you work outside of Nairobi?</h3>
                <p className="text-gray-600">
                  Yes! We work across 15 counties in Kenya, adapting our programs to meet local community needs while maintaining our core mission.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  We welcome partnerships with NGOs, government agencies, academic institutions, and private sector organizations. Contact us to explore collaboration opportunities.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  Donations directly support our programs in climate action, governance, and community empowerment. We provide regular updates on how funds are utilized.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Don't wait to make a difference. Join our community of changemakers today and help build a more sustainable and equitable future for Kenya.
          </p>
